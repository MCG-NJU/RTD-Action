...
class ANETproposal(object):
    ...
    def __init__(
        ...
        self.ground_truth = ground_truth_filename
        self.proposal = proposal_filename
...
def average_recall_vs_avg_nr_proposals(
    ...
    ground_truth_gbvn = ground_truth.groupby("video-name")
    proposals_gbvn = proposals.groupby("video-name")
    ...
    for videoid in video_lst:
        ...
        sort_idx = proposals_videoid["score"].astype(np.float).argsort()[::-1]
